...
/* harmony import */ var _components_blocks_taglist__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/blocks/taglist */ "./src/components/blocks/taglist.js");
...
const ContactSignupForm = () => {
  ...
  const [phone, setPhone] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [email, setEmail] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [hobbies, setHobbies] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  ...
  const handleSubmit = async e => {
    ...
    const response = await fetch(`${appLocalizer.apiUrl}/contact-signup/v1/contact`, {
      method: "POST",
      headers: {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
    ...
    type: "email",
    required: true
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_blocks_taglist__WEBPACK_IMPORTED_MODULE_4__["default"], {
    hobbies: hobbies,
    setHobbies: setHobbies
  }), error && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "error"
  }, error), success && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "success"
  }, success), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ui_button__WEBPACK_IMPORTED_MODULE_5__.Button, {
    variant: "default",
    type: "submit"
  }, "Sign Up")));
};
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)("contact-signup/form", {
...
/***/ "./src/components/blocks/taglist.js":
/*!******************************************!*\
  !*** ./src/components/blocks/taglist.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const predefinedHobbies = ["Fishing", "Running", "Reading", "Cooking", "Traveling", "Gardening"];
const TagList = ({
  hobbies,
  setHobbies
}) => {
  const [inputValue, setInputValue] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [filteredHobbies, setFilteredHobbies] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(predefinedHobbies);
  const [focusedIndex, setFocusedIndex] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(-1);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    setFilteredHobbies(predefinedHobbies.filter(hobby => hobby.toLowerCase().includes(inputValue.toLowerCase()) && !hobbies.includes(hobby)));
  }, [inputValue, hobbies]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
  ...
  const handleInputKeyDown = event => {
    if (event.key === "Enter") {
      if (inputValue) {
        setHobbies(prevHobbies => [...prevHobbies, inputValue.charAt(0).toUpperCase() + inputValue.slice(1)]);
        setInputValue("");
        setIsDropdownOpen(false);
      }
      ...
      setFocusedIndex(prevIndex => Math.min(filteredHobbies.length - 1, prevIndex + 1));
    } else if (event.key === "ArrowUp") {
      setFocusedIndex(prevIndex => Math.max(-1, prevIndex - 1));
    } else if (event.key === "Enter" && focusedIndex >= 0) {
      setHobbies(prevHobbies => [...prevHobbies, filteredHobbies[focusedIndex]]);
      setInputValue("");
      setIsDropdownOpen(false);
      setFocusedIndex(-1);
    }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "tag-list"
  }, hobbies.map((hobby, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    key: index
  }, hobby, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    type: "button",
  ...
  }), isDropdownOpen && filteredHobbies.length > 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    className: "tag-list-dropdown",
    ref: dropdownRef
  }, filteredHobbies.map((hobby, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    key: index,
    onClick: () => handleHobbySelect(hobby),
    style: {
      backgroundColor: focusedIndex === index ? "#d0d0d0" : "transparent"
    },
...
var buttonVariants = (0,class_variance_authority__WEBPACK_IMPORTED_MODULE_2__.cva)("inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50", {
  variants: {
    variant: {
      default: "bg-primary text-primary-foreground shadow hover:bg-primary/90 border-none",
...
var Button = react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(function (_a, ref) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Comp, __assign({
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_contact_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blocks/contact-form */ "./src/blocks/contact-form.js");
/* harmony import */ var _blocks_contact_card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./blocks/contact-card */ "./src/blocks/contact-card.js");
